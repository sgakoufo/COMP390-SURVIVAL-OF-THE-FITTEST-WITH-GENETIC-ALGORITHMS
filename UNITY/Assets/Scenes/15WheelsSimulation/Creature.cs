...
public class Creature : MonoBehaviour
{
    ...
    MovementScript carMovementScript;
    ...
    {  
        ...
        wheelArray[1].WheelNoParent("backWheel",-x1, -x2, y, creatureObject, creatureBodyRB, creatureColor);  
    }
    ...
    public void CreatureWithParent(int creatureNum_, int creatureGen_, Color generationColor_, Creature cr1, Creature cr2){
        ...
        // Back wheel:
        wheelArray[1] = new Wheel();
        wheelArray[1].WheelWithParent("backWheel",-x1, -x2, y, creatureObject, creatureBodyRB, creatureColor, cr1.wheelArray[1], cr2.wheelArray[1]);
    }
    ...
    void generateCreature(){
        ...
        carMovementScript = creatureBody.AddComponent<MovementScript>();// Add the movement scipr to the CREATURE BODY
