...
//     CreatureMovement creatureMovementScript;
...
//         // speed:
//         speed = Random.Range(0f,100); //generate speed value randoml.
...
//         wheelArray[0].WheelNoParent("frontWheel",x1, x2, y, creatureObject, creatureBodyRB, creatureColor);
//         // Back wheel:
//         wheelArray[1] = new Wheel();
//         wheelArray[1].WheelNoParent("rearWheel",-x1, -x2, y, creatureObject, creatureBodyRB, creatureColor);  
//         assignMovement();
//     }
...
//         // Front wheel:
//         wheelArray[0] = new Wheel();
//         wheelArray[0].WheelWithParent("frontWheel",x1, x2, y, creatureObject, creatureBodyRB, creatureColor, cr1.wheelArray[0], cr2.wheelArray[0]);
//         // Back wheel:
//         wheelArray[1] = new Wheel();
//         wheelArray[1].WheelWithParent("rearWheel",-x1, -x2, y, creatureObject, creatureBodyRB, creatureColor, cr1.wheelArray[1], cr2.wheelArray[1]);
...
//         creatureBody.AddComponent<CreatureMovement>();// Add the movement scipr to the CREATURE BODY
//         creatureMovementScript = creatureBody.GetComponent<CreatureMovement>();   
//                                                                                           // Create a reference to the script so we can
//         creatureMovementScript.setFrontWheel(creatureObject.transform.Find("frontWheel").gameObject.transform);
//         creatureMovementScript.setRearWheel(creatureObject.transform.Find("rearWheel").gameObject.transform);
//         creatureMovementScript.setCreatureBodyRB(creatureBodyRB);                                                                                   // chage the speed
//         creatureMovementScript.setSpeed(speed); 
//     }
